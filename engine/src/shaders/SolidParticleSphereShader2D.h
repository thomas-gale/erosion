...
class SolidParticleSphereShader2D : public GL::AbstractShaderProgram {
public:
  enum ColorMode { UniformDiffuseColor = 0, RampColorById };

  explicit SolidParticleSphereShader2D();

  SolidParticleSphereShader2D &setNumParticles(Int numParticles);
  SolidParticleSphereShader2D &setParticleRadius(Float radius);

  SolidParticleSphereShader2D &setColorMode(Int colorMode);
  SolidParticleSphereShader2D &setColor(const Color3 &color);

  SolidParticleSphereShader2D &setViewport(const Vector2i &viewport);
  SolidParticleSphereShader2D &setViewProjectionMatrix(const Matrix3 &matrix);
  SolidParticleSphereShader2D &setScreenHeight(Int height);
  SolidParticleSphereShader2D &setDomainHeight(Int height);
